...
def get_links_with_years(url):
    ...
    if response.status_code == 200:
        ...
        # Filtrer le lien contenant le dernier mois de l'année 2023
        for link in all_links:
            href = link['href']
            if re.search(r'2023-10', href) and 'yellow' in href.lower():
...
# Répertoire de destination pour enregistrer les fichiers Parquet
dossier_destination =r"../../data/raw"
